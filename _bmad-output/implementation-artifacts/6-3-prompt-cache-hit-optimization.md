...
- 2026-07-12: Repaired the SCP-049 production baseline and ran the corrected paired-delta authority gate (`--profile promotion --reps 3`, 16k; artifact `tmp/eval-prompts/20260712-105849-1783821529137928646-candidate-production/`). Verdict **FAIL**: SCP-049 total −1.00, SCP-173 article_fidelity −0.33, SCP-096 total −0.83. No majority item failure, so this is quality-delta evidence. No 6.3/6.4 production labels moved; status remains `in-progress`. Full detail in `6-3-6-4-review-metrics-report.md`.
